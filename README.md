...
| [FeedTableViewController](https://github.com/jwplayer/jwplayer-ios-bestPracticeApps/tree/main/JWBestPracticeApps/FeedTableViewController) | Simple implementation of JWPlayerKit SDK in an 'infinite' scrolling table view. |
